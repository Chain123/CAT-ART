...
for i in 11 12 13
do
/data/miniconda3/bin/python main_cross_pre.py --num_run "${i}" --domain "${domain}" --epoch 50 --n_worker 8 --cross "${method}" --batch_size 8129 --fix_user True --knowledge "d_in" --encoder_loss "rec"
done
